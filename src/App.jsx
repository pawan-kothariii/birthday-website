    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Nidhi</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Nidhi's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — LEVEL 💖</h2>
          <p className="final-subtitle">Happy Birthday! ✨</p>
        </section>
      </div>
